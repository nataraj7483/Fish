...
public class God {
	...
	public String toString() {
		return "God[name="+name+",color="+color+",noOfHands="+noOfHands+",isGod="+isGod+",location="+location+",state="+state+",poojariName="+poojariName+",number="+number+",salary="+salary+",noOfGods="+noOfGod+"]";
	}	
	public boolean equals(Object object) {
		if(object instanceof God) {
			God god=(God) object;
			
			if(this.name.equals(god.name)
					&&this.color.equals(god.color)
					&&this.state.equals(god.state)
