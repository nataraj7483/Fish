...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-light bg-dark">
		<div class="container-fluid">
			<a class="navbar-brand" href="#"
				...
				<a href="FireStationNameSearch.jsp">Search By StatinName</a>
		</div>
	</nav>
	<h1>Welcome to Fire Station Update page</h1>
	...
	<div class="mb-3" >
			<label for="formFile" class="form-label">Id</label> <input
				type="text" class="form-control" name="id" id="formFile" required="required"
		...
		<div class="mb-3" >
			<label for="formFile" class="form-label">StationName</label> <input
				...
				placeholder="Enter StationName" value="${dto.stationName}" />
		</div>
		<div class="mb-3">
			...
			<option selected value="${dto.fireStationNo}">${dto.fireStationNo}</option>
			...
			<option selected value="${dto.noOfVehicles}">${dto.noOfVehicles}</option>
